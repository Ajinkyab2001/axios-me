...
function getTodos() {
  ...
  // 4th method - we dont need to write "get " its by default
...
function addTodo() {
  ...
  // 2nd method
  axios.post('https://jsonplaceholder.typicode.com/todos',{     //// pass url nd data
    title: 'new data ',
    completed: false
  })
  .then(res => showOutput(res))
...
// patch will update or increment it
function updateTodo() {
  // axios.put('https://jsonplaceholder.typicode.com/todos/1',{     ////just added 1 after url to the url its the id and pass the data
  //   title: 'updated put data ',
  //   completed: true
  // })
  // .then(res => showOutput(res))

  axios.patch('https://jsonplaceholder.typicode.com/todos/1',{
    title: 'updated patch data ',
    completed: true
  })
  .then(res => showOutput(res))
  .catch(err => console.log(err))
